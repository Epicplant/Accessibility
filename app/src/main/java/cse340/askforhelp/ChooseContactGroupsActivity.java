    ...
    private void setContactNames() {
        ...
        for (int ii = 0; ii < mContactGroups.size(); ii++ ) {
            ...
            if(contacts.isEmpty()) {
                ...
                //textView.setContentDescription(getString(R.string.select_empty_contact));
                textView.setContentDescription("");
                textView.setEnabled(false);
            } else{
                textView.setContentDescription(getString(R.string.contact_group) + " " + contacts);
        ...
        TextView title = findViewById(R.id.chooseContactsTitle);
        if(allEmpty) {
            title.setContentDescription(getString(R.string.empty_contacts));
        } else {
        ...
        for (int ii = 0; ii < mContactGroups.size(); ii++ ) {
            ...
            mContactGroups.get(ii).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    mContactGroups.get(newInt).announceForAccessibility(
                            mContactGroups.get(newInt).getText().toString() +
                           getString(R.string.selected_contacts));
